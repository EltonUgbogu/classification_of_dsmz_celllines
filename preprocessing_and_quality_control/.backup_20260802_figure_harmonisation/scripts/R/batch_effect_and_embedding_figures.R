...
##   "qc"      recessive grid + light full axes (the VST/dispersion scatters)
##   "numeric" no grid, dark left/bottom axis lines, short outward ticks and
##             numeric labels (PCA, whose coordinates are quantitative)
##   "bare"    no grid, no ticks, no tick labels, only the two axis lines
##             (UMAP, whose coordinates have no direct numerical meaning)
figure_panel_frame <- function(x, y, xlab, ylab, main = NULL, subtitle = NULL,
