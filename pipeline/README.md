...
Explore the pipeline's output visually — a live, force-directed simulation of the cell line similarity networks generated by `compute_cell_line_similarity.R`:
