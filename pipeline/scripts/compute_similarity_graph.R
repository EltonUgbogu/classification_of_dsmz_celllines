...
#
# PURPOSE:
# Computes sample-sample similarity matrix and kNN graph from an expression
# matrix. Adapted from compute_dsmz_dsmz_similarity.R pattern but works
# directly with expression matrices (genes × samples).
#
# INPUTS:
