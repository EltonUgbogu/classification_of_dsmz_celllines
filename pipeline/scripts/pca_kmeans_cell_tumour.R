...
option_list <- list(
  ...
  make_option("--cell_label",    type = "character", default = "CELL"),
  make_option("--tumour_label",  type = "character", default = "TUMOUR"),
...
run_agnostic_clustering(
  ...
  cell_label       = opt$cell_label,
  tumour_label     = opt$tumour_label
)
