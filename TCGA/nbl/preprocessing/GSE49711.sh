#!/bin/bash
#SBATCH --job-name=GSE49711
#SBATCH --chdir=/home/chu25
#SBATCH --output=/home/chu25/TCGA/logs/GSE49711/%j.out
#SBATCH --error=/home/chu25/TCGA/logs/GSE49711/%j.err
#SBATCH --ntasks=1
...
# ---------- config ----------
LIST=/home/chu25/data/nbl/GSE49711/SRP109627.txt  # one SRR per line
BASE=/home/chu25/data/nbl/GSE49711
SRA_DIR="${BASE}/sra"
FASTQ_DIR="${BASE}/fastq"
LOG_ROOT=/home/chu25/TCGA/logs
JOB_LOG_DIR="${LOG_ROOT}/GSE49711"
