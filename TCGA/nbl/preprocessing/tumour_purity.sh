#!/bin/bash
#SBATCH --job-name=nbl_purity_analysis
#SBATCH --chdir=/home/chu25/TCGA/nbl/preprocessing
#SBATCH --output=/home/chu25/TCGA/nbl/logs/%x_%j.out
#SBATCH --error=/home/chu25/TCGA/nbl/logs/%x_%j.err
#SBATCH --ntasks=1
...
R_SCRIPT="/home/chu25/TCGA/nbl/preprocessing/tumour.R"
if [[ ! -f "$R_SCRIPT" ]]; then
