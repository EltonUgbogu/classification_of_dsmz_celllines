#!/bin/bash
#SBATCH --job-name=GSE100148
#SBATCH --chdir=/home/chu25
#SBATCH --output=/home/chu25/TCGA/logs/GSE100148/%j.out
#SBATCH --error=/home/chu25/TCGA/logs/GSE100148/%j.err
#SBATCH --ntasks=1
...
# ---------- config ----------
LIST=/home/chu25/data/nbl/GSE100148/SRP109627.txt  # one SRR per line
BASE=/home/chu25/data/nbl/GSE100148
SRA_DIR="${BASE}/sra"
FASTQ_DIR="${BASE}/fastq"
LOG_ROOT=/home/chu25/TCGA/logs
JOB_LOG_DIR="${LOG_ROOT}/GSE100148"
