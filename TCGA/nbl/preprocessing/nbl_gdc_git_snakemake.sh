...
#SBATCH --output=/home/chu25/TCGA/nbl/logs/nbl_gdc_%j.out
#SBATCH --error=/home/chu25/TCGA/nbl/logs/nbl_gdc_%j.err
#SBATCH --ntasks=1
...
# Initialize Conda environment. Adjust path if your installation differs.
...
snakemake --snakefile nbl_gdc_rnaseq_pipeline.smk --unlock
...
snakemake \
  --snakefile nbl_gdc_rnaseq_pipeline.smk \
