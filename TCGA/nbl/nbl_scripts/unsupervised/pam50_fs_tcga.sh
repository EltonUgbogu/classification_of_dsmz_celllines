...
#SBATCH --job-name=tcga_hc_pam50
#SBATCH --output=/home/chu25/dsmz/old_scripts/nbl_analysis/nbl/unsupervised/logs/tcga_hc_pam50_%j.out
#SBATCH --error=/home/chu25/dsmz/old_scripts/nbl_analysis/nbl/unsupervised/logs/tcga_hc_pam50_%j.err
#SBATCH --ntasks=1
...
# Run R script
echo "Starting TCGA Breast Cancer HC analysis..."
Rscript TCGA-BRCA_PAM50_FS_analysis.R
STATUS=$?
exit $STATUS
