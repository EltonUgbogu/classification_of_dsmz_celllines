...
#SBATCH --job-name=hvg_tcga
#SBATCH --output=/home/chu25/dsmz/old_scripts/nbl_analysis/nbl/unsupervised/logs/hvg_tcga_%j.out
#SBATCH --error=/home/chu25/dsmz/old_scripts/nbl_analysis/nbl/unsupervised/logs/hvg_tcga_%j.err
#SBATCH --ntasks=1
...
# Run R script
echo "Starting TCGA hvg analysis via R script..."
Rscript hvg_feature_subset_tcga_nbl.R 
STATUS=$?
exit $STATUS
