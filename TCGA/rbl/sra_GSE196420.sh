#!/bin/bash
#SBATCH --job-name=GSE196420
#SBATCH --chdir=/home/chu25
#SBATCH --output=/home/chu25/TCGA/logs/sra_GSE196420/%j.out
#SBATCH --error=/home/chu25/TCGA/logs/sra_GSE196420/%j.err
#SBATCH --ntasks=1
...
# ---------- config ----------
LIST=/home/chu25/data/rbl/GSE196420/rb_GSE196420.txt   # one SRR per line
BASE=/home/chu25/data/rbl/GSE196420
SRA_DIR="${BASE}/sra"
FASTQ_DIR="${BASE}/fastq"
LOG_ROOT=/home/chu25/TCGA/logs
JOB_LOG_DIR="${LOG_ROOT}/sra_GSE196420"
