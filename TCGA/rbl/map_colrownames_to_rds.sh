...
#SBATCH --job-name=map_colrownames_to_rds
#SBATCH --output=/home/chu25/TCGA/rbl/logs/map_colrownames_to_rds_%j.out
#SBATCH --error=/home/chu25/TCGA/rbl/logs/map_colrownames_to_rds_%j.err
#SBATCH --ntasks=1
...
# Run R script
echo "Starting mapping column names to RDS..."
Rscript map_colrownames_to_rds.R
STATUS=$?
exit $STATUS
