---
title: "TCGA Tumour Purity Estimation with tidyestimate"
author: "chu25"
...
```
```{r libraries}
# install required packages (prefer preinstall on HPC to avoid solver delays)
required_packages <- c(
...
```
```{r get_estimate_scoring_function}
...
```
```{r run_tidyestimate_purity_analysis}
...
run_tidyestimate_purity_analysis <- function(
  ...
  output_dir = "/home/chu25/TCGA/results/tumour_purity_results",
