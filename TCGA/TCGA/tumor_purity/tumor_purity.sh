...
#SBATCH --chdir=/home/chu25/dsmz/scripts
#SBATCH --output=/home/chu25/dsmz/logs/tcga_estimate_purity/%x_%j.out
#SBATCH --error=/home/chu25/dsmz/logs/tcga_estimate_purity/%x_%j.err
#SBATCH --ntasks=1
...
# Output folder
OUT_DIR="/home/chu25/dsmz/results/tcga_estimate_purity"
mkdir -p "$OUT_DIR" || { echo "Failed to create output directory $OUT_DIR"; exit 1; }

# Ensure input R script exists
R_SCRIPT="/home/chu25/dsmz/scripts/tcga_estimate_purity.R"
if [[ ! -f "$R_SCRIPT" ]]; then
