...
#SBATCH --output=/home/chu25/dsmz/logs/picard/multiqc_picard%j.out
#SBATCH --error=/home/chu25/dsmz/logs/picard/multiqc_picard%j.err
#SBATCH --ntasks=1
...
snakemake \
  --snakefile /home/chu25/dsmz/scripts/multiqc/picard/Snakefile \
  --cores 1 \
  --use-conda
