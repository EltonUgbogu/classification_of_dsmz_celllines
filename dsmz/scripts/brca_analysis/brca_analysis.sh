...
#SBATCH --output=/home/chu25/dsmz/scripts/brca_analysis/logs/dsmz_tcga_brca_subtypes_%j.out
#SBATCH --error=/home/chu25/dsmz/scripts/brca_analysis/logs/dsmz_tcga_brca_subtypes_%j.err
#SBATCH --ntasks=1
