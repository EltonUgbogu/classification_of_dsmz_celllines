...
write_metrics(DSMZ / 'ranked_marker_source_panel_dsmz_graph_metrics.tsv', {
    ...
    'feature_genes_requested': 379,
    'feature_genes_used': 379,
    'nodes': len(nodes),
    'edges': len(edges),
...
copy_file(umap / 'coords_pan_cancer_tumour_cell_line_alignment_umap_DEG_SET_cosine.tsv', EMBED / 'ranked_marker_source_panel_umap_coordinates.tsv')
copy_file(umap / 'Fig_pan_cancer_tumour_cell_line_alignment_umap_DEG_SET_SOURCE_CANCER_cosine.pdf', EMBED / 'ranked_marker_source_panel_umap.pdf')
...
write_metrics(MOUT / 'ranked_marker_source_panel_multicohort_summary_metrics.tsv', {
    ...
    'feature_genes_requested': 379,
    'feature_genes_found': 379,
    'feature_genes_missing': 0,
    'duplicated_feature_ids_before_cleaning': 0,
    'final_genes_used': 379,
