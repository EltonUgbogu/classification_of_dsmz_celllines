...
def main() -> int:
    ...
    readme.write_text(
        "# Legacy pan-cancer marker-framework enrichment query sets\n\n"
        "Generated local query/background inputs for manual g:Profiler use or parser/plotter testing. "
        "The completed final ranked marker-source-panel enrichment run uses the method-specific query manifest and public-endpoint g:Profiler output directory. "
