...
This document is a **complete task file for an agent**, detailing the analysis progress and which scripts to use. It is derived from the repository-root `Snakefile`.
